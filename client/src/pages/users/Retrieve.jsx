...
export default function Retrieve() {
  ...
  const validateCodeStep = () => {
    ...
    if (!inputCode.code.trim()) {
      ...
      newErrors.code = "Code must be 6 digits and integers";
    }
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.ok) {
          setSnackbar({
            open: true,
            message: "Password changed successfull! Redirecting...",
            severity: "success",
          });
    ...
    <div className="h-screen overflow-hidden">
      ...
      <MaxWidthWrapper>
        <div className="mt-8 fixed md:px-0 px-8 inset-0 md:w-[70%] h-full m-auto z-10 flex justify-center items-center">
          <form
            onSubmit={openForm ? submitPassword : openCode ? verifyCode : sendEmail}
