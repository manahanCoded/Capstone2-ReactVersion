  ...
  return (
    <>
      <div className="mt-14 max-sm:overflow-x-hidden">
        ...
        {/* PAGE 2 */}
        <MaxWidthWrapper className="py-10 flex md:flex-row flex-col items-center  bg-red-900">
          <section>
            <h2 className="md:text-4xl text-2xl font-semibold text-white max-sm:text-xl">
              <span className="text-[#FDE68A]">Engage, Learn,</span> and{' '}
              <span className="text-[#FDE68A]">Earn Confidence</span> in Blockchain
            </h2>
          ...
          <section className='flex flex-wrap gap-4 text-xs  justify-'>
        ...
        <MaxWidthWrapper className="flex  xl:flex-row flex-col justify-center gap-4 bg-gray-100 py-14 xl:px-36 lg:px-14 ">
          <h3 className='text-4xl font-extralight'>New <span className='decoration-red-800 font-normal underline decoration-4 '>free</span> online modules</h3>
          <div className=''>
                ...
                modules.length > 0 ? (
                  modules.slice(0, 3).map((module, index) => (
                    <Link
                      ...
                      key={index}
                      className="md:h-[24rem] h-[16rem]  flex flex-col justify-between lg:w-[19rem] md:w-64 sm:w-96  w-96   border border-b-2 border-b-red-800 rounded-xl bg-white overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 shadow-[1px_0px_20px_2px_rgba(0,_0,_0,_0.1)]"
                    >
                      <div
        ...
        {/* Partners Section */}
        <section className="relative -top-8 pt-14 pb-8 inline-block w-screen overflow-hidden  max-sm:py-4 max-sm:static">
          <MaxWidthWrapper>
        ...
        {/* PAGE 6 */}
        <MaxWidthWrapper className="lg:h-[38rem] h-fit md:relative py-8 flex lg:flex-row flex-col mb-14 bg-white">
          <section className="xl:w-[38%] lg:w-[26%] py-4 h-full left-0 lg:absolute flex flex-col items-center justify-center md:rounded-br-[14rem] lg:bg-gray-100 lg:shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]">
            <h2 className="xl:text-4xl md:text-2xl text-lg font-semibold lg:text-start text-center text-[#333333] lg:w-[70%] mb-4 ">
            ...
            <p className="md:text-base text-sm mt-1 lg:text-start text-center lg:w-[70%]">
          ...
          <section className="lg:absolute xl:right-8 md:right-0 flex md:flex-row flex-col justify-center items-center gap-4 ">
