    ...
    >
      {isPickingCategory ? (
        <div className=" picking-bg fixed bg-opacity-60 bg-black left-0 top-40 w-[100%] h-[110%]  flex items-center justify-center -mt-40 z-10 pointer-events-auto">
          <div className="game-modal content bg-[url('../../../public/Game_images/dont-fall2.png')] max-w-[1100px] w-full max-h-[570px] h-full text-center rounded-lg p-8 mb-24 flex flex-col justify-center items-center">
