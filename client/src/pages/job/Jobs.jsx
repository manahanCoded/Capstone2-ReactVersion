            ...
            <div className="flex flex-wrap flow-row sm:gap-6 gap-x-2 gap-y-6">
              {currentJobs.map((job, index) => (
                <section
                  ...
                  className={`xl:w-96 md:w-80 sm:w-72 w-[14.5rem] sm:h-[24rem]  flex flex-col justify-between py-1 gap-y-2 pb-4  md:px-2 border-[1px] rounded-2xl hover:border-red-950 `}
                >
                  <div className={`relative overflow-hidden sm:h-72 h-56 flex flex-col justify-between rounded-3xl p-4 ${!job.file_data && "bg-[#333333]"}`}>
                    <img
                    ...
                    <div className="w-full flex flex-wrap flex-row items-center sm:gap-4 gap-2 md:text-[0.7rem] text-[0.5rem] text-black">
                      <p className="px-2 py-1 rounded-full tracking-wide bg-white">
                        {job.remote}
                      </p>
                      <p className="px-2 py-1 rounded-full  tracking-wide bg-white">
                        {job.jobtype}
                    ...
                    <div className="flex flex-row items-center sm:gap-2 gap-1">
                      {checkAdmin?.role === "admin" && (
                        <Link
                          ...
                          className="line-clamp-1 border-[1px] md:font-medium text-xs rounded-md sm:p-2 px-1 py-0.5  bg-[#333333] hover:bg-[#121212] text-white"
                        >
                          Edit Job
                      ...
                      <Link
                        ...
                        className="line-clamp-1 border-[1px] md:font-medium  text-xs rounded-md sm:p-2 px-1 py-0.5 bg-red-900 hover:bg-red-700 text-white"
                      >
                        Details
