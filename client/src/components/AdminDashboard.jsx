        ...
        <section>
            <MaxWidthWrapper className="h-12 flex flex-row justify-between items-center border-b-2 ">
                ...
                <section className="w-full text-xs flex flex-row justify-start gap-8 ">
                    ...
                    <Link
                        to="/admin-email" className={`${location.pathname === "/admin-email" ? "px-3 py-2 rounded-2xl bg-gray-200 border-[1px]" : ""}w-20  flex justify-center items-center hover:text-gray-500 font-semibold px-3 py-2  cursor-pointer`}>
                        Email
                    </Link>
