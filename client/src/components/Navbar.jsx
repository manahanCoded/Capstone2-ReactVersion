          ...
          <section className=" fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="h-[42rem] w-[80vw] bg-white py-6 rounded-lg shadow-lg  ">
              <section className='flex flex-row justify-between border-b px-6 pb-2'>
                <h3 className='text-2xl font-bold tracking-wide text-red-900'>Notification</h3>
                <button
                  onClick={closeModal}
                    ...
                    >
                      <div className='flex flex-row gap-2 items-center'>
                        ...
                        <div className='text-xs'>
                          <p className="group-hover:text-white truncate line-clamp-1">{announcement.name ? announcement.name : announcement.email}</p>
                          <p className="group-hover:text-white  break-words line-clamp-1">{announcement.title}</p>
                          <p className="group-hover:text-white truncate line-clamp-1">{timeAgo(announcement.date)}</p>
                        </div>
                      </div>
                      <ArrowForwardIosIcon />
                    </div>
